        ...
        <div class="row">
                ...
                <div class="row">
                    <!-- <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><small class="pull-right m-t-10 text-success"><i class="fa fa-sort-asc"></i> 18% High then last month</small> Income Analysis</h5>
                                <div class="stats-row">
                                    <div class="stat-item">
                    ...
                    <!-- <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><small class="pull-right m-t-10 text-danger"><i class="fa fa-sort-desc"></i> 18% High then last month</small>Income Analysis</h5>
                                <div class="stats-row">
                                    <div class="stat-item">
                                        <h6>Overall Growth</h6> <b>80.40%</b></div>
                                    <div class="stat-item">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body bg-purple">
                                        <h5 class="text-white card-title">Line Chart</h5>
                ...
                <!-- <div class="row">
                    <div class="col-sm-12 col-xs-12 col-md-12 col-lg-6 ">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">bar with different color Chart</h5>
