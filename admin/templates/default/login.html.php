    ...
    <body class="skin-default card-no-border">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">My FILL APP ADMIN PANEL</p>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <section id="wrapper">
            <div class="login-register" style="background-image:url('assets/images/background/login-register.jpg');">
                <div class="login-box card">
                    ...
                    echo $message;
                ?></div>
                        <form method="POST" action="<?php echo Request::$BASE_PATH.'login'?>"
                            ...
                            <div class="form-group text-center">
                                <div class="col-xs-12 p-b-20">
                                    <button type="submit" class="btn btn-block btn-lg btn-info btn-rounded">Log
                                        In</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                                    <div class="social">
                                        <button class="btn  btn-facebook" data-toggle="tooltip"
                                            title="Login with Facebook"> <i aria-hidden="true"
                                                class="fab fa-facebook-f"></i> </button>
                                        <button class="btn btn-googleplus" data-toggle="tooltip"
                        ...
                        <form class="form-horizontal" id="recoverform"
                            action="<?php echo Request::$BASE_PATH.'forgot'?>">
                            <div class="form-group ">
                                <div class="col-xs-12">
        ...
        $('#loginbtnA').click(function(e) {
            e.preventDefault();

            url = "<?php echo Request::$BASE_PATH.'ajax/login'?>";
            email = $('email').val();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    console.log(data);
                    if (typeof(data.callback) != "undefined" && data.callback !== null) {
                        //    window.location(data.callback);
                    }
                    res = '<div class="alert alert-danger">' + data.message +
