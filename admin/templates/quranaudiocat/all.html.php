        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <a href="<?php echo Request::$BASE_PATH.$md['con'].'/new?catID='.$cat->id?>"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title"><?php echo ucfirst($cat->name.' Audios') ;?></h4>
                                ...
                                <table id="example23"
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a href="<?php echo Request::$BASE_PATH.$md['con'].'/edit/'.$d->id.'?catID='.$cat->id?>"
...
$(document).ready(function() {
    ...
    $("#delete").click(function() {
        ...
        controller = '<?php echo $md['con']?>';
        $.ajax({
            type: 'POST',
            url: '<?php echo Request::$BASE_PATH."customdelete"?>',
            data: {
                id: row,
                table: table,
                con: controller,
