					...
					<div class="card-body">
						<form class="form" method="POST" action="<?php echo Request::$BASE_PATH.$md['con'].'/edit/'.$Data->id?>">
							...
							<div class="form-group mt-5 row">
								...
								<div class="col-10">
									<input class="form-control" value="<?php echo $Data->label?>" type="text" name="label" id="example-text-input">
								</div>
							</div>
							<div class="form-group mt-5 row">
								<label for="example-text-input" class="col-2 col-form-label">Icon</label>
								<div class="col-10">
									<input class="form-control" value="<?php echo htmlentities(stripslashes(utf8_decode($Data->icon))); $Data->icon?>" type="text" name="icon" id="example-text-input">
								</div>
							</div>
