                         ...
                         <form class="form" method="POST" enctype='multipart/form-data'
                             ...
                             <div class="form-group mt-5 row">
                                 ...
                                 <div class="col-10">
                                     ...
                                     <input class="form-control" type="text" value="<?php echo $Data->question?>"
                                         name="question" required id="example-text-input">
                                 </div>
                             </div>
                             ...
                             <div class="form-group mt-5 row">
                                 ...
                                 <div class="col-10">
                                     ...
                                     <input class="form-control" type="text" value="<?php echo $Data->answer?>"
                                         name="answer" required id="example-text-input">
                                 </div>
                             </div>
