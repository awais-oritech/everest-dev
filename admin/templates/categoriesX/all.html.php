								...
								<table id="example23"
									...
									<tbody>
										...
										<tr role="row" class="odd">
											...
											<td>
												<span class="label <?php echo($d->is_tag=='1')?'label-success':'label-danger';?>"><?php echo ($d->is_tag=='1')?'Yes':'No' ;?></span>
											</td>
											<td>
												<span class="label <?php echo($d->is_featured=='1')?'label-success':'label-danger';?>"><?php echo ($d->is_featured=='1')?'Yes':'No' ;?></span>
											</td>
											<td>
