                 ...
                 <div class="card">
                     <div class="card-body">
                         <form class="form" method="POST" enctype='multipart/form-data'
                             ...
                             <div class="form-group mt-5 row">
                                 <label for="example-text-input" class="col-2 col-form-label">Old PDF</label>
                             ...
                             <div class="form-group mt-5 row">
                                 <label for="example-text-input" class="col-2 col-form-label">New PDF</label>
                                 <div class="col-10">
                             ...
                             <div class="form-group mt-5 row">
                                 ...
                                 <div class="col-10">
                                     ...
                                     <input class="form-control" type="number" value="<?php echo $Data->level?>"
                                         name="level" required id="example-text-input">
                                 </div>
                             </div>
