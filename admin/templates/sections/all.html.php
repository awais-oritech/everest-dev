	...
	<div class="container-fluid">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor"><?php echo ucfirst($md['con']) ;?></h4>
			</div>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<h4 class="card-title"><?php echo ucfirst($md['con']) ;?></h4>
								...
								<table id="example23"
									...
									<tbody>
										...
										<tr role="row" class="odd">
											<td class="sorting_1"><?php echo $d->module?></td>
											<td class="sorting_1"><?php echo $d->name?></td>
											<td class="sorting_1"><?php echo $d->actions?></td>
