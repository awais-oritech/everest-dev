		...
		<div class="row page-titles">
			...
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
					<a href="<?php echo Request::$BASE_PATH.$md['con'].'/new'?>" class="btn btn-info d-none d-lg-block m-l-15">
								...
								<table id="example23"
									...
									<tbody>
										...
										<tr role="row" class="odd">
											...
											<td class="sorting_1"><?php echo $d->role?></td>
											<td class="sorting_1"><?php echo $d->email?></td>
											<td class="sorting_1"><img alt="Profle" height="60" width="auto" src="<?php echo Request::$BASE_PATH.$d->image ?>"></td>
											<td class="sorting_1"><?php echo $d->phone?></td>
											
											<td>
												<span class="label <?php echo($d->is_active=='1')?'label-success':'label-danger';?>"><?php echo ($d->is_active=='1')?'Yes':'No' ;?></span>
											<td>
											 <a href="<?php echo Request::$BASE_PATH.$md['con'].'/edit/'.$d->id?>" class="btn btn-warning btn-rounded"><i class="fa fa-edit"></i></a>
    										 <a href="javascript:void(0);" id="row<?php echo $d->id?>" data-rec="<?php echo $d->id?>" class="del btn btn-danger btn-rounded"><i class="fa fa-trash"></i></a>
											</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close mdclose" data-dismiss="modal" aria-label="Close" ><span aria-hidden="true">&times;</span></button>
            </div>
...
$(document).ready(function() {
    ...
    $( ".del" ).click(function() {
        ...
        var data='<input type="hidden" name="table" id="table" value="<?php echo $md['table']?>"><input type="hidden" name="id" class="rowid" value="'+id+'">';
        $( "#deleteform" ).empty();
