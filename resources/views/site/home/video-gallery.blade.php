            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <article class="blog">
                            <figure>
                                <a href="{{url('videos',[$album->id])}}"><img src="https://pioneers.oritech.co/admin/{{$album->image}}" alt="" style="height: 100%; width:100%;">
                                    <div class="preview"><span>View more</span></div>
                                </a>
                            </figure>
                            <div class="post_info">
                                {{-- <small>{{ \Carbon\Carbon::parse($album->created)->format('d-m-Y')}}</small> --}}
                                <h2><a href="{{url('videos',[$album->id])}}">{{$album->name}}</a></h2>
