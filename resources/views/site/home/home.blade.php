                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption ">
                                <h5 class="animated bounceInRight" style="animation-delay: 1s">INTERNATIONAL NETWORK
                                    <br> BUILD ON FOUNDATION OF <br>SAFETY AND TRUST</h5>
                                <p class="animated bounceInLeft" style="animation-delay: 2s">Find what you need!</p>
                                <a href="{{route('member')}}" class="hvr-sweep-to-right buttons animated bounceInRight"
                                    style="animation-delay: 3s">Become Member</a>
                            </div>
                        </div>
                        <div class="carousel-item ">

                            <div class="carousel-caption">
                                <h5 class="animated bounceInRight" style="animation-delay: 1s">Beating all other mobile
                                    figures previously covered by Oftel.</h5>
                                <p class="animated bounceInLeft" style="animation-delay: 2s">Just do it</p>
                                <a href="" class="hvr-sweep-to-right buttons animated bounceInRight"
                                    style="animation-delay: 3s">Become Member</a>
                            </div>
                        </div>
                        <div class="carousel-item ">
                            ...
                            <div class="carousel-caption ">
                                <h5 class="animated bounceInRight" style="animation-delay: 1s">The people you need are
                                    only a touch away.</h5>
                    ...
                    <div class="formbox-header animated bounceInUp" style="animation-delay:3s">
                        <form method="GET" action="{{route('search')}}">
                            <div class="form-group col-xs-3">
                                <label for="exampleInputEmail1"><img src="{{ asset('assets/img/keyword.gif') }}"
                                        width="30px" height="30px"> Service</label>
                                <select id="" name="service_id" class="form-control"
                            ...
                            <div class="form-group col-xs-3">
                                <label for="continents"><img src="{{ asset('assets/img/country.gif') }}" width="30px"
                                        height="30px"> Continents</label>
                            ...
                            <div class="form-group col-xs-3">
                                <label for="country"><img src="{{ asset('assets/img/address.gif') }}" width="30px"
                                        height="30px"> Country</label>
                            ...
                            <div class="form-group col-xs-3">
                                <label for="city"><img src="{{ asset('assets/img/home.gif') }}" width="30px"
                                        height="30px"> City</label>
                            ...
                            <div class="buttonn">
                                ...
                                <a href="{{route('member')}}" type="button"
                                    class="hvr-sweep-to-right buttons">Search</a>
                                @endif
                            </div>
                        </form>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="formbox-header shadow-form animated bounceInUp" style="animation-delay:1s">
                <form method="GET">
                    <div class="form-group col-xs-3">
                        <label for="exampleInputEmail1"><img src="{{ asset('assets/img/keyword.gif') }}" width="30px"
                                height="30px"> Keyword</label>
                        <input type="text" class="form-control input-sm" id="exampleInputEmail1"
                            aria-describedby="emailHelp" placeholder="keyword">
                    </div>
                    <div class="form-group col-xs-3">
                        <label for="exampleInputPassword11"><img src="{{ asset('assets/img/home.gif') }}" width="30px"
                                height="30px"> Address</label>
                        <input type="text" class="form-control" id="exampleInputPassword11" placeholder="Address">
                    </div>
                    <div class="form-group col-xs-3">
                        <label for="exampleInputPassword1121"><img src="{{ asset('assets/img/country.gif') }}"
                                width="30px" height="30px"> Country</label>
                        <input type="text" class="form-control" id="exampleInputPassword1121" placeholder="Country">
                    </div>
                    <div class="form-group col-xs-3">
                        <label for="exampleInputPassword12"><img src="{{ asset('assets/img/address.gif') }}"
                                width="30px" height="30px"> City</label>
